...
const Main = () => {
  ...
  return (
    <header className="flex flex-col lg:flex-row justify-between mt-[23px] lg:mt-[90px]">
      <article className="lg:w-[50%] lg:self-center">
      ...
      <div className="lg:w-[50%] hidden lg:block lg:ml-[60px] self-center">
        <img src={jasaUruzinReal} alt="jasa uruzin" className="object-contain" />
      </div>
      ...
      <div className="overflow-hidden overflow-x-scroll">
        <div className="lg:hidden mt-[44px] flex pb-[14px] gap-[25px]  ">
          <div className="shrink-0 flex justify-between w-[234px] h-[50px] bg-white-pure rounded-[20px] drop-shadow-xl shadow-black-pure ">
            <h1 className=" ml-[23px] self-center font-poppins font-semibold text-black-pure text-[16px] tracking-[0px] leading-[60px]">
              Pendirian PT,CV
            </h1>
            <img src={checked} alt="jasa uruzin" className=" z-50 h-[67px] self-center translate-x-2" />
          </div>
          <div className="shrink-0 flex justify-between w-[183px] h-[50px] bg-white-pure rounded-[20px] drop-shadow-xl shadow-black-pure ">
            <h1 className=" ml-[23px] self-center font-poppins font-semibold text-black-pure text-[16px] tracking-[0px] leading-[60px]">
              Halal MUI
            </h1>
            <img src={checked} alt="jasa uruzin" className=" z-50 h-[67px] self-center translate-x-2" />
        ...
        {/* //? ///////////////// */}
        <div className="lg:hidden flex  pt-[14px] pb-[22.5px] gap-[25px] ">
          <div className="shrink-0 flex justify-between w-[156px] h-[50px] bg-white-pure rounded-[20px] drop-shadow-xl shadow-black-pure ">
            <h1 className=" ml-[23px] self-center font-poppins font-semibold text-black-pure text-[16px] tracking-[0px] leading-[60px]">
              BPOM
            </h1>
            <img src={checked} alt="jasa uruzin" className=" z-50 h-[67px] self-center translate-x-2" />
