...
const CTA = () => {
  return (
    <>
      <div className="flex-col bg-gradient-to-br from-[#009d12] to-[#057812] rounded-lg shadow-[-10px_-10px_rgba(0,90,0,0.3)] px-14 pb-7 mx-48 max-w mb-44">
        <h1 className="text-white text-xl font-semibold mb-2 pt-7">Bingung mau mulai dari mana?</h1>
        <h2 className="text-gray-700 text-lg font-medium mb-10">Mulai konsultasi dengan Uruzin</h2>
