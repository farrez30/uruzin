    ...
    <section id="hubungi" className="flex flex-col mb-[70px]">
      <div className="flex items-center gap-[170px]">
        <article className="flex-col w-[50%]">
          ...
          <p className="font-poppins font-normal text-[16px] leading-[35px] text-gray-uruzin tracking-[0px] mb-5">
        ...
        <article className="w-[50%] mb-10 flex flex-col">
          <div className="flex flex-col mb-5">
            <h1 className="font-poppins font-semibold text-[20px] leading-[32px] text-primary-content-uruzin tracking-[0px] mb-[15px]">
              Head Office
            </h1>
            <p className="font-poppins font-normal text-[16px] leading-[25.6px] text-gray-uruzin tracking-[0px] mb-[35px]">
          ...
          <div className="flex flex-col max-w-[354px]">
            ...
            <div className="flex justify-between mb-[35px] gap-5">
              <a
                href=""
